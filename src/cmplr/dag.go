...
func (d Dag) MakeMainTest(root string) (*vector.Vector, string) {
    ...
    sbTotal.Add("\n// only a dummy func here at the moment\n");
    sbTotal.Add("var dummy = func(pat, str string)")
    sbTotal.Add("(bool, os.Error) {\n");
    sbTotal.Add("return true, nil\n}\n\n");

    sbTotal.Add("func main(){\n")
    sbTotal.Add("testing.Main(dummy, tests);\n")
    sbTotal.Add("testing.RunBenchmarks(dummy, benchmarks);\n}\n\n")
